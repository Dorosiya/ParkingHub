...
<head>
    ...
    <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=7de22b580589f48eae26aed074b09419"></script>
    <style>
        :root {
...
<body>
    ...
    <header class="parking-header">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <c:choose>
                        <c:when test="${parking.realtime != null && parking.realtime.nrmlparkingcnt > 10}">
                            <span class="badge bg-success status-badge">
                                <i class="bi bi-check-circle"></i> 주차가능
                            </span>
                        </c:when>
                        <c:when test="${parking.realtime != null && parking.realtime.nrmlparkingcnt > 0}">
            ...
            <div class="col-lg-8">
                    ...
                    <ul class="list-unstyled info-list">
                        ...
                        <li class="d-flex">
                            ...
                            <div>
                                ...
                                <span>${parking.info.opratorcontent == '공영' ? '공영주차장' : '민영주차장'}</span>
                            </div>
                        </li>
                        <li class="d-flex">
                            ...
                            <div>
                                <strong>연락처:</strong> 
                                <span>${empty parking.info.phonenumber ? '연락처 정보 없음' : parking.info.phonenumber}</span>
                            </div>
                        </li>
                ...
                <div class="detail-card">
                    ...
                    <div class="mt-3">
                        ...
                        <a href="https://map.kakao.com/link/to/${parking.info.prkingnm},${latitude},${longitude}" 
                ...
                <c:if test="${parking.operation != null}">
                    <div class="detail-card">
                        ...
                        <ul class="list-unstyled info-list">
                            ...
                            <c:if test="${not empty parking.operation.holidayoperationinfo}">
                                <li class="d-flex">
                        ...
                        <c:when test="${parking.realtime != null}">
                            <div class="text-center mb-4">
                                <div class="display-4 mb-2 
                                    ${parking.realtime.nrmlparkingcnt > 10 ? 'text-success' : 
                                     (parking.realtime.nrmlparkingcnt > 0 ? 'text-warning' : 'text-danger')}">
                        ...
                        <c:otherwise>
                            <div class="text-center py-4">
                                <div class="text-muted">
                                    ...
                                    <p class="mt-3">실시간 정보가 제공되지 않는 주차장입니다.</p>
                                </div>
                            </div>
                        </c:otherwise>
                    </c:choose>
    ...
    <div class="action-buttons">
        <button class="btn btn-primary action-button" title="길 안내" onclick="window.open('https://map.kakao.com/link/to/${parking.info.prkingnm},${latitude},${longitude}', '_blank')">
            <i class="bi bi-signpost-2"></i>
        </button>
        <c:if test="${not empty parking.info.phonenumber}">
            <a href="tel:${parking.info.phonenumber}" class="btn btn-success action-button" title="전화하기">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="/community" class="text-decoration-none footer-link">커뮤니티</a></li>
                    </ul>
                </div>
                <div class="col-md-4">
                    <h5>고객센터</h5>
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="reviewContent" rows="4" placeholder="주차장에 대한 경험을 공유해주세요."></textarea>
                        </div>
                    </form>
                </div>
    ...
    <script>
        ...
        window.onload = function() {
            ...
            const infowindow = new kakao.maps.InfoWindow({
                content: '<div style="padding:5px;font-size:12px;width:150px;text-align:center;">${parking.info.prkingnm}</div>'
            });
