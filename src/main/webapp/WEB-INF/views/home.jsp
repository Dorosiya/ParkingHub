        ...
        <div class="row">
          <div class="col-md-4">
            <div class="feature-card">
              ...
              <h3>실시간 주차장 검색</h3>
              <p>
                현재 위치 기반으로 가까운 주차장을 찾고, 실시간 주차 가능 여부를
                확인하세요.
              </p>
            </div>
          </div>
        ...
        <div class="row mt-4">
          <div class="col-md-4">
            <div class="feature-card">
              ...
              <h3>주차 통계</h3>
              <p>
                자주 가는 장소의 주차 패턴을 분석하여 최적의 주차 시간을
                추천해드립니다.
              </p>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-4 mb-4">
            <div class="card">
              <img
                src="https://via.placeholder.com/300x150?text=주차장+이미지"
                class="card-img-top"
                alt="주차장 이미지"
              />
              <div class="card-body">
                ...
                <p class="card-text">
                  ...
                  <i class="bi bi-currency-exchange text-success"></i> 시간당
                  3,000원<br />
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-8 mx-auto text-center">
            ...
            <p class="mb-4">
              Parking Hub 모바일 앱을 다운로드하여 언제 어디서나 주차장을 찾고
              예약하세요.
            </p>
            <div>
              <a href="#" class="btn btn-light me-2 mb-2"
                ><i class="bi bi-apple me-2"></i>App Store</a
              >
              <a href="#" class="btn btn-light mb-2"
                ><i class="bi bi-google-play me-2"></i>Google Play</a
              >
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 mb-4">
            <h5>Parking Hub</h5>
            <p>
              더 쉽고 빠른 주차 경험을 제공하는<br />스마트 주차 가이드 서비스
            </p>
            <div class="mt-3">
